  ...
  faqs: [
    {
      ...
      answer: `Yes, Dubai offers a tax-free environment, a stable economy, and high rental yields, making it a prime location for real estate investment.`,
    },
    {
      id: 2,
      question:
        "What are the best areas to invest in Dubai's real estate market?",
      answer: `Popular investment hotspots include Downtown Dubai, Palm Jumeirah, Dubai Marina, and Business Bay, known for their luxury villas and premium properties.`,
    },
    {
      id: 3,
      question:
        "How does GO Real Estate assist with off-plan properties in Dubai?",
      answer: `We provide expert guidance on selecting the best off-plan properties in the UAE, ensuring maximum returns and risk mitigation.`,
    },
    {
      id: 4,
      question: "What are the current trends in the Dubai property market?",
      answer: `Dubai's property market is experiencing a surge in luxury real estate investments, increased demand for commercial real estate, and steady growth in off-plan property sales.`,
    },
  ],
};
